  ...
  <div class="main">
    <form @submit.prevent="signup" autocomplete="off">
      <div class="items-container">
        <div class="item">
          <label class="attribute" for="name">ユーザー名</label>
        ...
        <div class="item">
          <label class="attribute" for="passwordconfirm">パスワード確認</label>
          <input id="passwordconfirm" v-model="form.password_confirm" type="password">
        </div>
      </div>
